...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.okhttpClient = new OkHttpClient(); //CORRECTION enhancement : only 1 okhttp
        this.gson = new Gson(); //CORRECTION enhancement :  only 1 gson
                        ...
                        public void onResponse(Call call, Response response) throws IOException {
                            ...
                            final User user = gson.fromJson(text, User.class);
                                ...
                                public void run() {
                                    ...
                                    avatar_urlTV.setText("Avatar URL: " + user.getAvatarUrl());
